      ...
      <ul className="space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">Student portal</span>
            </a>
         </li>
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div className="p-4 sm:ml-64">
   <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
      ...
      <div className="flex items-center justify-center h-90 mb-4 rounded-sm bg-gray-50 dark:bg-gray-800">
         <img src="332.gif" alt="Image 4" className="w-1200 h-full" />
      </div>
      <div className="grid grid-cols-4 gap-4 mb-4">
         <div className="flex items-center justify-center rounded-sm bg-gray-50 h-28 dark:bg-gray-800">
            <img src="334.gif" alt="Image 5" className="w-140 h-full" />
         </div>
         <div className="flex items-center justify-center rounded-sm bg-gray-50 h-28 dark:bg-gray-800">
            <img src="image6_url" alt="Image 6" className="w-10 h-10" />
         </div>
         <div className="flex items-center justify-center rounded-sm bg-gray-50 h-28 dark:bg-gray-800">
            <img src="image7_url" alt="Image 7" className="w-10 h-10" />
         </div>
         <div className="flex items-center justify-center rounded-sm bg-gray-50 h-28 dark:bg-gray-800">
            <img src="image8_url" alt="Image 8" className="w-10 h-10" />
         </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
         ...
         <div className="flex items-center justify-center rounded-sm bg-gray-50 h-28 dark:bg-gray-800">
            <img src="image12_url" alt="Image 12" className="w-10 h-10" />
         </div>
         <div className="flex items-center justify-center rounded-sm bg-gray-50 h-28 dark:bg-gray-800">
            <img src="334.gif" alt="Image 13" className="w-120 h-full" />
         </div>
      </div>
   </div>
</div>
